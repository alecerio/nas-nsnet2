...
def init_calibration(mpq_config):
    ...
    calib['onnxMatMul_207'] = CalibrationParam(mpq_config[34], False, -1.3657219409942627, 1.158295750617981, 'ONNX__MATMUL_207_')
    calib['fc2bias'] = CalibrationParam(mpq_config[35], False, -0.1750922054052353, 0.1385071724653244, 'FC2_BIAS_')
    calib['onnxMatMul_208'] = CalibrationParam(mpq_config[36], False, -3.1666038036346436, 2.5026357173919678, 'ONNX__MATMUL_208_')
    calib['fc3bias'] = CalibrationParam(mpq_config[37], False, -0.10188056528568268, 0.0899151861667633, 'FC3_BIAS_')
    calib['onnxMatMul_209'] = CalibrationParam(mpq_config[38], False, -1.300571084022522, 1.928941249847412, 'ONNX__MATMUL_209_')
    calib['fc4bias'] = CalibrationParam(mpq_config[39], False, -0.10699586570262909, 0.04597663879394531, 'FC4_BIAS_')
    ...
    calib['fc2MatMul'] = CalibrationParam(mpq_config[84], False, -0.769360363483429, 0.43505313992500305, 'FC2MATMUL_')
    calib['fc2Add'] = CalibrationParam(mpq_config[85], False, -0.9315677881240845, 0.5329311490058899, 'FC2ADD_')
    calib['relu'] = CalibrationParam(mpq_config[86], False, 0.0, 0.5329311490058899, 'RELU_')
    calib['fc3MatMul'] = CalibrationParam(mpq_config[87], False, -2.872364044189453, 0.898455798625946, 'FC3MATMUL_')
    calib['fc3Add'] = CalibrationParam(mpq_config[88], False, -2.890881061553955, 0.8957681655883789, 'FC3ADD_')
    calib['relu_1'] = CalibrationParam(mpq_config[89], False, 0.0, 0.8957681655883789, 'RELU_1_')
    calib['fc4MatMul'] = CalibrationParam(mpq_config[90], False, -2.5626792907714844, -0.9808969497680664, 'FC4MATMUL_')
    calib['fc4Add'] = CalibrationParam(mpq_config[91], False, -2.569243907928467, -0.9619374871253967, 'FC4ADD_')
